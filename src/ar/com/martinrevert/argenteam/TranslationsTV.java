...
import com.fedorvlasov.lazylist.LazyAdapterTV;
...
public class TranslationsTV extends CustomMenu {
	...
	private class AsyncRequest extends AsyncTask<Void, Void, Void> {
		...
		ProgressDialog dialog = new ProgressDialog(TranslationsTV.this);
		...
		protected Void doInBackground(Void... arg0) {
			...
			String uri = "http://www.argenteam.net/rss/portal_series_translations.xml";
			try {
			...
			adapter = new LazyAdapterTV(TranslationsTV.this, titulo, imag,
					fech, ver, post);
